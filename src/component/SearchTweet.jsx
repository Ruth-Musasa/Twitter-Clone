export default function SearchTweet() {
    return (
        <div className="bg-zinc-800 w-full h-11 rounded-full p-2 flex justify-around">
            <span>
            ...
            <input type="search" name="search" id="search" className='bg-zinc-800' placeholder='Serach Twitter' />
        </div>
    )
}